...
- The current admin MVP includes dashboard, profile, clubs, and members; public routes currently cover `/login`, `/join/[clubId]`, and `/system/health`.
...
- `src/app/system/health/page.tsx` preserves the API diagnostics flow.
